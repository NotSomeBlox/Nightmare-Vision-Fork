...
class CrashReportSubstate extends FlxState {
    ...
    override public function create(){
		...
		var formattedErrorMessage:String = 'The engine has crashed! \nThe following error was caught: ${errorName}\n\n${error}\n\nPlease report this error to GitHub or DuskieWhy on Discord.';
		...
		underText = new FlxText(0, FlxG.height - 64, FlxG.width, "Press SPACE to return to Menu.");
