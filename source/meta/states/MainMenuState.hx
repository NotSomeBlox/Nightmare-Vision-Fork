...
{
	public static var psychEngineVersion:String = 'Official Github Release'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "NightmareVision Engine:", 12);
